...
3. Create new repository with name: Automation
...
# Resolve the repository root (this script lives in deployment/scripts/)
...
REPO_URL="https://${GITHUB_USERNAME}:${GITHUB_TOKEN}@github.com/${GITHUB_USERNAME}/Automation.git"
...
echo "  ✅ On GitHub: https://github.com/$GITHUB_USERNAME/Automation"
